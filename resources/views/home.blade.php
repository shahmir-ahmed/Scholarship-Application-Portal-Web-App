...
<head>
		...
		<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start': new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0], j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src= '../../../www.googletagmanager.com/gtm5445.html?id='+i+dl;f.parentNode.insertBefore(j,f); })(window,document,'script','dataLayer','GTM-5FS8GGP');
        </script>
		<!--End::Google Tag Manager -->
		<style>
			#card{
				background-image: url('.../resources/css/card.jpg');
	...
	<body id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" class="bg-white position-relative app-blank">
		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
						...
						<div class="container">
							...
							<div class="d-flex align-items-center justify-content-between">
								...
								<div class="d-flex align-items-center flex-equal">
									...
									<!--begin::Logo image-->
									<a href="{{route('home')}}">
										<img alt="Logo" src="{{asset('Eziline/Scholarship Management System/public/logo.png')}}" class="logo-default h-75px h-lg-100px" style="filter: invert()"/>
								...
								<div class="d-lg-block" id="kt_header_nav_wrapper">
									<div class="d-lg-block p-5 p-lg-0" data-kt-drawer="true" data-kt-drawer-name="landing-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="200px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_landing_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav_wrapper'}">
										...
										<div class="menu menu-column flex-nowrap menu-rounded menu-lg-row menu-title-gray-500 menu-state-title-primary nav nav-flush fs-5 fw-semibold" id="kt_landing_menu">
											...
											<div class="menu-item">
												<!--begin::Menu link-->
												<a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#scholarships" data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Scholarships</a>
												<!--end::Menu link-->
											</div>
											<!--end::Menu item-->
											<!--begin::Menu item-->
                                ...
                                @else
                                <div class="flex-equal text-end ms-1">
                                    <a href="{{route('profile')}}" class="btn btn-primary" style="margin: 10px"><i class="fa-regular fa-user"></i></a>

                                    <a href="{{ route('logout') }}"
                                    onclick="event.preventDefault();
                                                  document.getElementById('logout-form').submit();" class="btn btn-danger"><i class="fa-solid fa-power-off"></i></a>
					...
					<div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
						...
						<div class="d-flex flex-center flex-wrap position-relative px-5">
							...
							<div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Fujifilm">
								<img src="{{asset('Eziline/Scholarship Management System/public/media/svg/brand-logos/fujifilm.svg')}}" class="mh-30px mh-lg-40px" alt="" />
							</div>
							<!--end::Client-->
							<!--begin::Client-->
							<div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Vodafone">
								<img src="{{asset('Eziline/Scholarship Management System/public/media/svg/brand-logos/vodafone.svg')}}" class="mh-30px mh-lg-40px" alt="" />
							</div>
							<!--end::Client-->
							<!--begin::Client-->
							<div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="KPMG International">
								<img src="{{asset('Eziline/Scholarship Management System/public/media/svg/brand-logos/kpmg.svg')}}" class="mh-30px mh-lg-40px" alt="" />
							</div>
							<!--end::Client-->
							<!--begin::Client-->
							<div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Nasa">
								<img src="{{asset('Eziline/Scholarship Management System/public/media/svg/brand-logos/nasa.svg')}}" class="mh-30px mh-lg-40px" alt="" />
							</div>
							<!--end::Client-->
							<!--begin::Client-->
							<div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Aspnetzero">
								<img src="{{asset('Eziline/Scholarship Management System/public/media/svg/brand-logos/aspnetzero.svg')}}" class="mh-30px mh-lg-40px" alt="" />
							</div>
							<!--end::Client-->
							<!--begin::Client-->
							<div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="AON - Empower Results">
								<img src="{{asset('Eziline/Scholarship Management System/public/media/svg/brand-logos/aon.svg')}}" class="mh-30px mh-lg-40px" alt="" />
							</div>
							<!--end::Client-->
							<!--begin::Client-->
							<div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Hewlett-Packard">
								<img src="{{asset('Eziline/Scholarship Management System/public/media/svg/brand-logos/hp-3.svg')}}" class="mh-30px mh-lg-40px" alt="" />
							</div>
							<!--end::Client-->
							<!--begin::Client-->
							<div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Truman">
								<img src="{{asset('Eziline/Scholarship Management System/public/media/svg/brand-logos/truman.svg')}}" class="mh-30px mh-lg-40px" alt="" />
							</div>
							<!--end::Client-->
						</div>
						<!--end::Clients-->
			...
			<div class="mb-n10 mb-lg-n20 z-index-2">
				...
				<div class="container">
					...
					<div class="text-center mb-17">
						...
						<!--end::Title-->
						<!--begin::Text-->
						<div class="fs-5 text-muted fw-bold">Avail thousands to millions rupees scholarships by 
						<br />following these simple steps</div>
						<!--end::Text-->
					</div>
					<!--end::Heading-->
					<!--begin::Row-->
					<div class="row w-100 gy-10 mb-md-20">
						...
						<div class="col-md-4 px-5">
							...
							<div class="text-center mb-10 mb-md-0">
								<!--begin::Illustration-->
								<img src="{{asset('Eziline/Scholarship Management System/public/media/illustrations/sketchy-1/2.png')}}" class="mh-125px mb-9" alt="" />
								<!--end::Illustration-->
								<!--begin::Heading-->
								<div class="d-flex flex-center mb-5">
									...
									<!--end::Badge-->
									<!--begin::Title-->
									<div class="fs-5 fs-lg-3 fw-bold text-dark">Register yourself</div>
									<!--end::Title-->
								</div>
								<!--end::Heading-->
								<!--begin::Description-->
								<div class="fw-semibold fs-6 fs-lg-4 text-muted">
                                    Register yourself to apply for the scholarship
								{{-- <br /> --}}
						...
						<div class="col-md-4 px-5">
							...
							<div class="text-center mb-10 mb-md-0">
								<!--begin::Illustration-->
								<img src="{{asset('Eziline/Scholarship Management System/public/media/illustrations/sketchy-1/5.png')}}" class="mh-125px mb-9" alt="" />
								<!--end::Illustration-->
								<!--begin::Heading-->
								<div class="d-flex flex-center mb-5">
									<!--begin::Badge-->
									...
									<!--end::Badge-->
									<!--begin::Title-->
									<div class="fs-5 fs-lg-3 fw-bold text-dark">Find Your Scholarship</div>
									<!--end::Title-->
								</div>
								<!--end::Heading-->
								<!--begin::Description-->
								<div class="fw-semibold fs-6 fs-lg-4 text-muted">Choose from vast scholarships
                                    <br>
                                    from the scholarships section
								{{-- <br />through the resgistration 
								<br />amazing and great --}}
                            </div>
								<!--end::Description-->
							</div>
						...
						<div class="col-md-4 px-5">
							...
							<div class="text-center mb-10 mb-md-0">
								<!--begin::Illustration-->
								<img src="{{asset('Eziline/Scholarship Management System/public/media/illustrations/sketchy-1/4.png')}}" class="mh-125px mb-9" alt="" />
								<!--end::Illustration-->
								<!--begin::Heading-->
								<div class="d-flex flex-center mb-5">
									<!--begin::Badge-->
									...
									<!--end::Badge-->
									<!--begin::Title-->
									<div class="fs-5 fs-lg-3 fw-bold text-dark">Apply for the scholarship</div>
									<!--end::Title-->
								</div>
								<!--end::Heading-->
								<!--begin::Description-->
								<div class="fw-semibold fs-6 fs-lg-4 text-muted">Huzza! Now you can apply to any 
								<br />scholarship you want  to
								<br />start your amazing and great journey
                            </div>
								<!--end::Description-->
							</div>
							<!--end::Story-->
					...
					<div class="tns tns-default">
						...
						<div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000" data-tns-autoplay="true" data-tns-autoplay-timeout="18000" data-tns-controls="true" data-tns-nav="false" data-tns-items="1" data-tns-center="false" data-tns-dots="false" data-tns-prev-button="#kt_team_slider_prev1" data-tns-next-button="#kt_team_slider_next1">
							...
							<div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
								<img src="{{asset('Eziline/Scholarship Management System/public/media/product-demos/demo1.png')}}" class="card-rounded shadow mw-100" alt="" />
							</div>
							<!--end::Item-->
							<!--begin::Item-->
							<div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
								<img src="{{asset('Eziline/Scholarship Management System/public/media/product-demos/demo2.png')}}" class="card-rounded shadow mw-100" alt="" />
							</div>
							<!--end::Item-->
							<!--begin::Item-->
							<div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
								<img src="{{asset('Eziline/Scholarship Management System/public/media/product-demos/demo4.png')}}" class="card-rounded shadow mw-100" alt="" />
							</div>
							<!--end::Item-->
							<!--begin::Item-->
							<div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
								<img src="{{asset('Eziline/Scholarship Management System/public/media/product-demos/demo5.png')}}" class="card-rounded shadow mw-100" alt="" />
							</div>
							<!--end::Item-->
						</div>
						<!--end::Slider-->
			...
			<div class="mt-sm-n10" >
				<!--begin::Curve top-->
				<div class="landing-curve landing-dark-color" style="margin-top: 85px;">
				...
				<div class="pb-15 pt-18 landing-dark-bg">
					...
					<div class="container">
						<!--begin::Heading-->
						<div class="text-center mt-15 mb-18" id="about-us" data-kt-scroll-offset="{default: 100, lg: 100}">
							<!--begin::Title-->
							<h3 class="fs-2hx text-white fw-bold mb-5">We Make Studies Better</h3>
							<!--end::Title-->
							<!--begin::Description-->
							<div class="fs-5 text-gray-700 fw-bold">Avail thousands to millions of scholarships from this single platform 
							</div>
							<!--end::Description-->
						</div>
						<!--end::Heading-->
							...
							<div class="d-flex flex-wrap flex-center justify-content-lg-between mb-15 mx-auto w-xl-900px">
								...
								<div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain" style="background-image: url('assets/media/svg/misc/octagon.svg')">
									...
									<div class="mb-0">
										...
										<!--end::Value-->
										<!--begin::Label-->
										<span class="text-gray-600 fw-semibold fs-5 lh-0">Associated Institutes</span>
										<!--end::Label-->
									</div>
									<!--end::Info-->
								</div>
								...
								<div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain" style="background-image: url('assets/media/svg/misc/octagon.svg')">
									...
									<div class="mb-0">
										...
										<!--end::Value-->
										<!--begin::Label-->
										<span class="text-gray-600 fw-semibold fs-5 lh-0">Application Statistics Reports</span>
										<!--end::Label-->
									</div>
									<!--end::Info-->
								</div>
								...
								<div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain" style="background-image: url('assets/media/svg/misc/octagon.svg')">
									...
									<div class="mb-0">
										...
										<!--end::Value-->
										<!--begin::Label-->
										<span class="text-gray-600 fw-semibold fs-5 lh-0">Secure Subscription Payments</span>
										<!--end::Label-->
									</div>
									<!--end::Info-->
								</div>
						...
						<span class="fs-1 lh-1 text-gray-700">“</span>When you care about your studies, you’ll worry about it in a 
						<br />
						...
						<div class="fs-2 fw-semibold text-muted text-center">
							...
							<span class="fs-4 fw-bold text-gray-600">ABC Vice Chancellor</span>
						</div>
						<!--end::Author-->
					</div>
					<!--end::Container-->
			...
			<div class="py-10 py-lg-20">
				...
				<div class="container">
					...
					<div class="text-center mb-12">
						<!--begin::Title-->
						<h3 class="fs-2hx text-dark mb-5" id="scholarships" data-kt-scroll-offset="{default: 100, lg: 150}">Our Latest Scholarships</h3>
						<!--end::Title-->
						<!--begin::Sub-title-->
					...
					<div class="tns tns-default" style="direction: ltr">
						...
						<div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000" data-tns-autoplay="true" data-tns-autoplay-timeout="18000" data-tns-controls="true" data-tns-nav="false" data-tns-items="1" data-tns-center="false" data-tns-dots="false" data-tns-prev-button="#kt_team_slider_prev" data-tns-next-button="#kt_team_slider_next" data-tns-responsive="{1200: {items: 3}, 992: {items: 2}}">
							...
							{{-- <div class="text-center"> --}}
								<!--begin::Photo-->
								{{-- <div class="square mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" id="card">
								</div> --}}
								<!--end::Photo-->
								<!--begin::Person-->
								{{-- <div class="mb-2">
									<!--begin::Name-->
									<a href="#" class="text-dark fw-bold text-hover-primary fs-3">Scholarship name</a>
									<!--end::Name-->
									<!--begin::Position-->
									<div class="text-muted fs-6 fw-semibold mt-1">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Omnis, saepe unde aliquid consectetur, totam laudantium, 10</div>
									<!--begin::Position-->
							...
							{{-- <div class="flex md:w-1/3">
								<a href="" class="bg-white shadow p-6 text-black rounded no-underline group transition-shadow hover:shadow-lg mx-2 mb-4 w-full" target="_blank"><!----><div>
									<h3 class="font-bold text-lg group-hover:text-primary-500 group-hover:underline">Philadelphia injury lawyers p.c. essay competition $500 scholarship – 2023</h3><!---->
									<div class="mt-4 flex justify-between">
										<div>
											<div><!----></div>
											<div>
												<span class="bg-gray-100 inline-block mr-2 py-1 px-3 text-sm text-gray-600 rounded mb-1">
													<div class="inline-block align-middle fill-current text-gray-600 mr-1 scale-75">
														<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"><path d="M3 6h18v12H3V6m9 3a3 3 0 0 1 3 3 3 3 0 0 1-3 3 3 3 0 0 1-3-3 3 3 0 0 1 3-3M7 8a2 2 0 0 1-2 2v4a2 2 0 0 1 2 2h10a2 2 0 0 1 2-2v-4a2 2 0 0 1-2-2H7Z"></path>
														</svg>
													</div>
													$500
												</span>
							...
							<!--begin::Item-->
							<div class="text-center" style="padding:10px; margin: 0px 20px; background: #FFEEEE;  /* fallback for old browsers */
							...
							background: linear-gradient(to right, #DDEFBB, #FFEEEE); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
							  ...
							  border-radius: 18px">
								<!--begin::Photo-->
								<div class=" mx-auto mb-5 d-flex w-250px h-200px" >
									<p style="padding:5px; margin-top: auto; margin-bottom: auto; width: 100%; line-height: 3rem; text-align: left;">
										<span style="font-size: 16px"><i class="fa-solid fa-bookmark" style="color:black"></i> <b> {{$scholarship->scholarship_name}} </b> </span><br>
										<i class="fa-solid fa-circle-info" style="color:black"></i> {{substr($scholarship->scholarship_desc, 0, 55)}}...<br>
										<i class="fa-solid fa-calendar" style="color:black"></i> 
										Last date to apply: 
										<i>
											@php
												$date = date_create($scholarship->scholarship_last_date);
												echo date_format($date, "d-F-Y");
											@endphp
										</i>
									</p>
								</div>
								{{-- href="{{route('scholarships', $scholarship->scholarship_id)}}" --}}
								<a class="btn btn-primary" href="{{route('scholarship.view', ['scholarshipId' => $scholarship->scholarship_id])}}">Details</a>
									<!--end::Photo-->
									<!--begin::Person-->
									{{-- <div class="mb-0">
										<!--begin::Name-->
					...
					{{-- <div class="d-flex justify-content-center align-items-center" style="margin-top: 50px">
						<a href="{{route('scholarships')}}" class="btn btn-success">View All</a>
					</div> --}}
				</div>
				<!--end::Container-->
			</div>
					...
					<div class="card" style="filter: drop-shadow(0px 0px 40px rgba(68, 81, 96, 0.08))">
						...
						<div class="card-body p-lg-20">
							...
							<div class="text-center mb-5 mb-lg-10">
								<!--begin::Title-->
								<h3 class="fs-2hx text-dark mb-5" id="portfolio" data-kt-scroll-offset="{default: 100, lg: 250}">Scholarship news</h3>
								<!--end::Title-->
							</div> --}}
							<!--end::Heading-->
							<!--begin::Tabs wrapper-->
			...
			<div class="mt-sm-n20">
				<!--begin::Curve top-->
				<div class="landing-curve landing-dark-color" style="margin-top: 150px">
					<svg viewBox="15 -1 1470 48" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M1 48C4.93573 47.6644 8.85984 47.3311 12.7725 47H1489.16C1493.1 47.3311 1497.04 47.6644 1501 48V47H1489.16C914.668 -1.34764 587.282 -1.61174 12.7725 47H1V48Z" fill="currentColor"></path>
					</svg>
				</div>
					...
					<div class="container">
						...
						<div class="d-flex flex-column container pt-lg-20">
							...
							<div class="mb-13 text-center">
								<h1 class="fs-2hx fw-bold text-white mb-5" id="pricing" data-kt-scroll-offset="{default: 100, lg: 150}">Get fresh scholarship opportunities every day.</h1>
								<div class="text-gray-600 fw-semibold fs-5">Receive the daily email that 10.000's 
								<br />of students use to get the latest scholarships</div>
							</div>
							<!--end::Heading-->
							<!--begin::Pricing-->
							{{-- 
							<div class="text-center" id="kt_pricing">
								...
								<div class="nav-group landing-dark-bg d-inline-flex mb-15" data-kt-buttons="true" style="border: 1px dashed #2B4666;">
									<a href="#" class="btn btn-color-gray-600 btn-active btn-active-success px-6 py-3 me-2 active" data-kt-plan="month">Annual</a>
							...
							<div class="col-md-6">
								...
								{{-- <div class="card">
									...
									<div class="text-center">
										...
										<span class="d-block mt-3">Subscribe to our newsletter in order not to miss new scholarships <br> events and news of our website</span>
										...
										<div class="mx-5">
											...
											<form action="{{route('send-mail')}}" method="POST">
												<div class="input-group mb-3 mt-4">
													...
													<input type="text" class="form-control" placeholder="Enter name" name="userName" aria-label="Your name" aria-describedby="button-addon2" required>
												</div>
												<input type="email" class="form-control" placeholder="Enter email" name="userEmail" aria-label="Your email" aria-describedby="button-addon2" required>
												
												@if(!Auth::check())
												<a style="margin: 10px 5px" href="{{route('register')}}" class="btn btn-success border-rad" id="button-addon2">Let me register!</a>

												@else
												<button style="margin: 10px 5px" type="submit" class="btn btn-success border-rad" id="button-addon2">Yes, I want scholarship oppurtunities</button>
												@endif
											</form>
								...
								{{-- <div class="col-xl-4"> --}}
									...
									<div class="d-flex h-100 align-items-center">
										...
										<div class="w-100 d-flex flex-column flex-center rounded-3 bg-primary py-15 px-10">
											...
											<div class="mb-7 text-center">
												<!--begin::Title-->
												<h1 class="text-white mb-5 fw-boldest">Gold Customer</h1>
												<!--end::Title-->
												<!--begin::Description-->
												<div class="text-white opacity-75 fw-semibold mb-5">Best Investment for customer like you!</div>
												<!--end::Description-->
												<!--begin::Price-->
												<div class="text-center">
													<span class="mb-2 text-white">$</span>
													<span class="fs-3x fw-bold text-white" data-kt-plan-price-month="999" data-kt-plan-price-annual="9999">3.99</span>
													<span class="fs-7 opacity-75 fw-semibold text-white" data-kt-plan-price-month="Mon" data-kt-plan-price-annual="Ann">/ Mon</span>
												</div>
												<!--end::Price-->
											</div>
											<!--end::Heading-->
											...
											<div class="w-100 mb-10">
												<!--begin::Item-->
												<div class="d-flex flex-stack mb-5">
													<span class="fw-semibold opacity-75 fs-6 text-white text-start pe-3">Instant notification for new scholarships</span>
													<!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
													<span class="svg-icon svg-icon-1 svg-icon-white">
														<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
															<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
												...
												<!--begin::Item-->
												<div class="d-flex flex-stack mb-5">
													<span class="fw-semibold opacity-75 fs-6 text-white text-start pe-3">Instant notification for new events</span>
													<!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
													<span class="svg-icon svg-icon-1 svg-icon-white">
														<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
															<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
												...
												<!--begin::Item-->
												<div class="d-flex flex-stack mb-5">
													<span class="fw-semibold opacity-75 fs-6 text-white text-start pe-3">Instant notification for new news</span>
													<!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
													<span class="svg-icon svg-icon-1 svg-icon-white">
														<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
															<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
												...
												<!--begin::Item-->
												<div class="d-flex flex-stack mb-5">
													<span class="fw-semibold opacity-75 fs-6 text-white text-start pe-3">Special perks</span>
													<!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
													<span class="svg-icon svg-icon-1 svg-icon-white">
														<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
															<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
												...
												<!--begin::Item-->
												<div class="d-flex flex-stack">
													<span class="fw-semibold opacity-75 fs-6 text-white text-start pe-3">VIP Support</span>
													<!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
													<span class="svg-icon svg-icon-1 svg-icon-white">
														<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
															<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
				...
				<!--end::Wrapper-->
				<!--begin::Curve bottom-->
				<div id="news" class="landing-curve landing-dark-color">
					<svg viewBox="15 12 1470 48" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M0 11C3.93573 11.3356 7.85984 11.6689 11.7725 12H1488.16C1492.1 11.6689 1496.04 11.3356 1500 11V12H1488.16C913.668 60.3476 586.282 60.6117 11.7725 12H0V11Z" fill="currentColor"></path>
					</svg>
				</div>
					...
					<div class="row g-lg-10 mb-10 mb-lg-20">
						...
						<div class="col-lg-4">
							...
							<div class="d-flex flex-column justify-content-between h-lg-100 px-10 px-lg-0 pe-lg-10 mb-15 mb-lg-0">
								...
								<div class="mb-7">
									...
									<!--end::Rating-->
									<!--begin::Title-->
									<div class="fs-2 fw-bold text-dark mb-3">This is by far the cleanest website 
									<br />and the most well structured</div>
									<!--end::Title-->
									<!--begin::Feedback-->
									<div class="text-gray-500 fw-semibold fs-4">The most well thought out designed website I have ever used. The codes are up to standard. The css styles are very clean. In fact the cleanest and the most up to standard I have ever seen.</div>
									<!--end::Feedback-->
								</div>
								<!--end::Wrapper-->
								<!--begin::Author-->
						...
						<div class="col-lg-4">
							...
							<!--end::Carousel-->
								...
								<div style="margin-top: 130px !important; width: 60%; margin-left:auto; margin-right:auto;" id="events" class="separator separator-content border-danger my-15">
							...
							<!--begin::Team Section-->
							<div id="kt_carousel_4_carousel" style="width:60%; margin-top:150px; margin-left: auto; margin-right:auto;" class="carousel carousel-custom slide" data-bs-ride="carousel" data-bs-interval="2000">
								<!--begin::Heading-->
								<div class="d-flex align-items-center justify-content-between flex-wrap">
									<!--begin::Label-->
									<span class="fs-4 fw-bold pe-2"><i class="fa-solid fa-calendar-days" style="color: rgb(79, 79, 79)"></i> Events Section</span>
									<!--end::Label-->
							
									<!--begin::Carousel Indicators-->
									<ol class="p-0 m-0 carousel-indicators carousel-indicators-dots carousel-indicators-active-primary">
										{{-- Always shown if there is news or no news --}}
										<li data-bs-target="#kt_carousel_4_carousel" data-bs-slide-to="0" class="ms-2 active"></li>

										@for ($i = 1; $i < count($events); $i++)
										<li data-bs-target="#kt_carousel_4_carousel" data-bs-slide-to="{{$i}}" class="ms-2"></li>
										@endfor($eventsCount)

										{{-- <li data-bs-target="#kt_carousel_4_carousel" data-bs-slide-to="1" class="ms-1"></li>
										<li data-bs-target="#kt_carousel_4_carousel" data-bs-slide-to="2" class="ms-1"></li> --}}
									</ol>
									<!--end::Carousel Indicators-->
								</div>
								<!--end::Heading-->
								...
								<!--begin::Carousel-->
								<div class="carousel-inner pt-8">
									{{-- For loop to know that which one is first event --}}
									{{-- @for ($i = 0; $i < $eventsCount; $i++) --}}

									
									{{-- only show if there is no events to display --}}
									@if(count($events)==0)
									...
									@if($i==1)
									<div class="carousel-item active">
										<i class="fa-solid fa-calendar" style="color: rgb(79, 79, 79)"></i> {{$events[$i-1]['event_name']}} <br> <br>
										<i class="fa-solid fa-circle-info" style="color: rgb(79, 79, 79)"></i> {{$events[$i-1]['event_desc']}} <br> <br>
										<i class="fa-solid fa-location-dot" style="color: rgb(79, 79, 79)"></i> {{$events[$i-1]['event_location']}} <br> <br>
										<i class="fa-solid fa-clock" style="color: rgb(79, 79, 79)"></i> {{$events[$i-1]['event_time']}}
									</div>
									<!--end::Item-->
									@else
									<!--begin::Item-->
						...
						<div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
							...
							<ul class="menu menu-gray-600 menu-hover-primary fw-semibold fs-6 fs-md-5 order-1 mb-5 mb-md-0">
								...
								<li class="menu-item mx-5">
									<a href="#none" class="menu-link px-2">Support</a>
								</li>
								<li class="menu-item">
									<a href="#pricing" class="menu-link px-2">Purchase</a>
								</li> --}}
								<li class="menu-item fw-bold fs-12">
									<span style="color:white!important">𝙷𝚊𝚗𝚍 𝙲𝚛𝚊𝚏𝚝𝚎𝚍 & 𝙼𝚊𝚍𝚎 𝚆𝚒𝚝𝚑 ❤️ 𝚋𝚢</span><a href="https://github.com/shahmir-ahmed" target="_blank" class="d-inline menu-link px-2" style="color: orange">𝚂𝚑𝚊𝚑𝚖𝚒𝚛 𝙰𝚑𝚖𝚎𝚍</a>
								</li>
							</ul>
							<!--end::Menu-->
						</div>
		...
		<script src="{{asset('Eziline/Scholarship Management System/public/plugins/custom/fslightbox/fslightbox.bundle.js')}}"></script>
		<script src="{{asset('Eziline/Scholarship Management System/public/plugins/custom/typedjs/typedjs.bundle.js')}}"></script>
		<!--end::Vendors Javascript-->
		<!--begin::Custom Javascript(used for this page only)-->
		<script src="{{asset('Eziline/Scholarship Management System/public/js/custom/landing.js')}}"></script>
		<script src="{{asset('Eziline/Scholarship Management System/public/js/custom/pages/pricing/general.js')}}"></script>
		<!--end::Custom Javascript-->
		<!--end::Javascript-->
	</body>
	<!--end::Body-->

<!-- Mirrored from preview.keenthemes.com/metronic8/demo1/landing.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Oct 2022 11:10:48 GMT -->
</html>