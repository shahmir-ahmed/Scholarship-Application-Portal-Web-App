												...
												<table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
													...
													<tbody>
														...
														<tr>
															...
															<td>
																<span class="text-dark fw-bold fs-6">{{$news->news_name}}</span>
															</td>
															<td>
																<span href="#" class="text-muted fw-bold d-block mb-1 fs-6">{{substr($news->news_desc, 0, 40)}}...</span>
															</td>
															<td>
																<span class="text-dark fw-bold fs-6">{{$news->created_at}}</span>
															</td>
															<td class="text-end">
