...
<head>
	...
	<body id="kt_body" class="app-blank app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
				...
				<div class="d-flex flex-lg-row-fluid">
					...
					<div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
						<!--begin::Image-->
						<img class="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20" src="{{asset('Eziline/Scholarship Management System/public/media/auth/agency.png')}}" alt="" />
						<img class="theme-dark-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20" src="{{asset('Eziline/Scholarship Management System/public/media/auth/agency-dark.png')}}" alt="" />
						<!--end::Image-->
						<!--begin::Title-->
						...
						<div class="w-md-400px">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" action="{{route('register')}}" method="POST">
								...
								<div class="row g-3 mb-9">
									...
									<div class="col-md-6">
										...
										<a href="#" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
                                            <img alt="Logo" src="{{asset('Eziline/Scholarship Management System/public/media/svg/brand-logos/google-icon.svg')}}" class="h-15px me-3" />Continue with Google</a>
										<!--end::Google link=-->
									</div>
									<!--end::Col-->
									<!--begin::Col-->
									<div class="col-md-6">
										<!--begin::Apple link=-->
                                        <a href="#" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
										<img alt="Logo" src="{{asset('Eziline/Scholarship Management System/public/media/svg/brand-logos/github.svg')}}" class="theme-light-show h-15px me-3" />
										<img alt="Logo" src="{{asset('Eziline/Scholarship Management System/public/media/svg/brand-logos/github.svg')}}" class="theme-dark-show h-15px me-3" />Continue with github</a>
										<!--end::Apple link=-->
									</div>
									<!--end::Col-->
								</div>
								...
								<div class="fv-row mb-8">
									<!--begin::Name-->
									<input type="text" placeholder="Name" name="name" autocomplete="off" class="form-control bg-transparent @error('name') is-invalid @enderror" value="{{ old('name') }}" autocomplete="name" required>
								...
								<div class="fv-row mb-8">
									<!--begin::Email-->
									<input type="text" placeholder="Email" name="email" autocomplete="off" class="form-control bg-transparent @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
		...
		<script src="{{asset('Eziline/Scholarship Management System/public/js/custom/authentication/sign-up/general.js')}}"></script>
