                        ...
                        <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-100 mb-5 mb-xl-10" style="background-color: #F1416C;background-image:url('assets/media/patterns/vector-1.png')">
                            ...
                            <div class="card-header pt-5">
                                ...
                                <div class="card-title d-flex flex-column">
                                    <!--begin::Amount-->
                                    <span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2">{{$activeApplicationsCount}}</span>
                                    <!--end::Amount-->
                                    <!--begin::Subtitle-->
                            ...
                            <div class="card-body d-flex align-items-end pt-0">
                                ...
                                <div class="d-flex align-items-center flex-column mt-3 w-100">
                                    <div class="d-flex justify-content-between fw-bold fs-6 text-white opacity-75 w-100 mt-auto mb-2">
                                        <span>{{$completedApplicationsCount}} Completed</span>
                                        <span>{{$completedApplicationsPercentage}}%</span>
                                    </div>
                                    <div class="h-8px mx-3 w-100 bg-white bg-opacity-50 rounded">
                                        <div class="bg-white rounded h-8px" role="progressbar" style="width: 72%;" aria-valuenow="{{$completedApplicationsPercentage}}" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                                <!--end::Progress-->
                            </div>
                            ...
                            <div class="card-header pt-5">
                                ...
                                <div class="card-title d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--end::Currency-->
                                        <!--begin::Amount-->
                                        <span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">{{$earningsThisMonth}}</span>
                                        <!--end::Amount-->
                                        <!--begin::Badge-->
                                    ...
                                    <!--end::Info-->
                                    <!--begin::Subtitle-->
                                    <span class="text-gray-400 pt-1 fw-semibold fs-6">Subscriptions Earnings in {{$currentMonth}}</span>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Title-->
                            </div>
                            ...
                            <div class="card-body pt-2 pb-4 d-flex flex-wrap align-items-center">
                                ...
                                <div class="d-flex flex-column content-justify-center flex-row-fluid">
                                    ...
                                    <div class="d-flex fw-semibold align-items-center">
                                        ...
                                        <!--end::Bullet-->
                                        <!--begin::Label-->
                                        <div class="text-gray-500 flex-grow-1 me-4">Stripe</div>
                                        <!--end::Label-->
                                        <!--begin::Stats-->
                                        <div class="fw-bolder text-gray-700 text-xxl-end">${{$earningsThisMonth}}</div>
                                        <!--end::Stats-->
                                    </div>
                                    <!--end::Label-->
                                    <!--begin::Label-->
                    ...
                    <div class="col-xl-3">
                        ...
                        <a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-gray-900 fw-bold fs-2 mb-2 mt-5">{{$totalEarnings}}$</div>
                    ...
                    <div class="col-xl-3">
                        ...
                        <a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-gray-100 fw-bold fs-2 mb-2 mt-5">{{$usersCount}}</div>
                                <div class="fw-semibold text-gray-100">Total Users</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
                        ...
                        <a href="#" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-white fw-bold fs-2 mb-2 mt-5">
                                    @php
                                        $roundedEarning = round($totalEarnings);   
                                    @endphp
                                    {{-- @if($roundedEarning>=100)
                                    $100 --}}
                                    ${{$roundedEarning}}
                                </div>
                    ...
                    <div class="col-xl-3">
                        ...
                        <a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <div class="fw-semibold text-white">Milestone Not Reached</div>
                                @endif
                            </div>
                            <!--end::Body-->
                        </a>
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="card bg-light-success card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body my-3">
                                <a href="#" class="card-title fw-bold text-success fs-5 mb-3 d-block">Applications Progress</a>
                                <div class="py-1">
                                    <span class="text-dark fs-1 fw-bold me-2">{{$completedApplicationsPercentage}}%</span>

                                    {{-- Based on the %age of completetion remarks 
                                        0-30 low
                                        31-50 average
                                        51-80 good
                                        81-100 --}}
                                    @if($completedApplicationsPercentage>=0 && $completedApplicationsPercentage<=30)

                                    <span class="fw-semibold text-muted fs-7">Low</span>

                                    @elseif($completedApplicationsPercentage>=31 && $completedApplicationsPercentage<=50)

                                    <span class="fw-semibold text-muted fs-7">Average</span>

                                    @elseif($completedApplicationsPercentage>=51 && $completedApplicationsPercentage<=80)

                                    <span class="fw-semibold text-muted fs-7">Good</span>

                                    @elseif($completedApplicationsPercentage>=81 && $completedApplicationsPercentage<=100)

                                    <span class="fw-semibold text-muted fs-7">Perfect</span>

                                    @endif

                                </div>
                                <div class="progress h-7px bg-success bg-opacity-50 mt-7">
                                    <div class="progress-bar bg-success" role="progressbar" style="width: 50%" aria-valuenow="{{$completedApplicationsPercentage}}" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <!--end:: Body-->
                        </div>
        ...
        <div id="kt_app_footer" class="app-footer">
            ...
            <div class="app-container container-fluid d-flex flex-column flex-md-row flex-center flex-md-stack py-3">
                ...
                <ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
                    ...
                    <li class="menu-item">
                        <a href="https://1.envato.market/EA4JP" target="_blank" class="menu-link px-2">Contact</a>
                    </li>
                </ul>
                <!--end::Menu-->
            </div>
